...
var SpinWheelSkins = {
    'default': {
        outerCircle: { color: "gradient:linear:#fff:#fff", margin: 10, shadow: { type: 'outer' } },
        slice: { color: "rgba(255, 255, 255, 1)", margin: 20, offset: 2, shadow: { type: 'outer', blur: 2 }, bgcolors: ['#6D1CA0', '#FEB800', '#FA0769', '#00CDCC', '#FF7901', '#01B994', 'gradient:linear:#f3c5bd:#e86c57:#ea2803:#c72200'], text: { color: '#ffffff',  font_size: 10 } },
        innerCircle: [
